...
var _Alert = require('bootstrap-styled/lib/Alert');

var _Alert2 = _interopRequireDefault(_Alert);

var _Small = require('bootstrap-styled/lib/Small');
...
FormWrapperUnstyled.propTypes = {
  ...
  notification: _propTypes2.default.shape({
    ...
    type: _propTypes2.default.oneOf(['info', 'success', 'danger', 'primary', 'secondary', 'warning'])
  }),
