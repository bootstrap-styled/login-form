...
describe('<FormWrapper />', function () {
  ...
  var props = void 0;
  beforeEach(function () {
    theme = _withFormWrapper.defaultProps.theme;
    props = Object.assign(_withFormWrapper.defaultProps, {
      onSubmit: jest.fn(),
      onError: jest.fn(),
      onChange: jest.fn()
    });
    ...
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _bootstrapStyled.BootstrapProvider,
          { theme: theme },
          _react2.default.createElement(_LoginFormRedux2.default, _extends({}, props, { logo: logo }))
        )
      )
    ));
    ...
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _bootstrapStyled.BootstrapProvider,
          { theme: theme },
          _react2.default.createElement(_LoginFormRedux2.default, _extends({}, props, { version: 'Hello version' }))
        )
      )
    ));
    ...
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _bootstrapStyled.BootstrapProvider,
          { theme: theme },
          _react2.default.createElement(_LoginFormRedux2.default, _extends({}, props, {
