...
const plugins = [
  ...
  commonjs({
    ...
    namedExports: {
      ...
      './node_modules/redux/es/index.js': ['createStore', 'combineReducers', 'bindActionCreators', 'applyMiddleware', 'compose'],
      './node_modules/redux-form/es/immutable.js': ['Field', 'reduxForm'],
      './node_modules/redux-form/dist/redux-form.js': ['Field', 'reduxForm'],
