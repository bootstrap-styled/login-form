(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('styled-components'), require('classnames'), require('react-intl'), require('message-common'), require('react-dom'), require('loaders'), require('bootstrap-styled-motion'), require('react-redux'), require('redux')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'styled-components', 'classnames', 'react-intl', 'message-common', 'react-dom', 'loaders', 'bootstrap-styled-motion', 'react-redux', 'redux'], factory) :
	(factory((global['login-form'] = {}),global.React,global.PropTypes,global.styled,global.cn,global['react-intl'],global['message-common'],global.ReactDom,global.loaders,global['bootstrap-styled-motion'],global['react-redux'],global.redux));
}(this, (function (exports,_react,_propTypes,_styledComponents,_classnames,reactIntl,messages,_reactDom,loaders,bootstrapStyledMotion,reactRedux,redux) { 'use strict';
...
var _styledComponents__default = 'default' in _styledComponents ? _styledComponents['default'] : _styledComponents;
...
var _react2 = _interopRequireDefault(_react);
var _propTypes2 = _interopRequireDefault(_propTypes);
var _styledComponents2 = _interopRequireDefault(_styledComponents__default);
...
exports.default = (0, _styledComponents__default.withTheme)(Alert);
module.exports = exports['default'];
});
...
var theme$3 = makeTheme$1(_extends({}, theme$4, bootstrapStyledMotion.theme));
var defaultProps$1 = {
  header: null,
  footer: null,
  beforeButton: null,
...
var ErrorParagraph = _styledComponents__default(P).withConfig({
  ...
  return _react.createElement(
    ...
    touched && error && _react.createElement(
      ...
      _react.createElement(
        ...
        ' ',
        _react.createElement(reactIntl.FormattedMessage, { id: error }),
        ' ',
  ...
  return _react.createElement(
    ...
    _react.createElement(
      ...
      _react.createElement(Field$1, {
        name: 'username',
        type: 'text',
        label: _react.createElement(reactIntl.FormattedMessage, messages.formUsername),
    ...
    _react.createElement(
      ...
      _react.createElement(Field$1, {
        name: 'password',
        type: 'password',
        label: _react.createElement(reactIntl.FormattedMessage, messages.formPassword),
    ...
    _react.createElement(
      ...
      _react.createElement(
        ...
        _react.createElement(
          ...
          _react.createElement(reactIntl.FormattedMessage, messages.authLogin),
          (loading || submitting) && _react.createElement(
            'span',
            null,
            ' ',
            _react.createElement(loaders.LoadingIndicator, null)
          )
        )
      )
    ),
...
var LoginFormStyled = _styledComponents__default(LoginFormUnstyled).withConfig({
      ...
      return _react.createElement(
        ...
        _react.createElement(
          ...
          notification.text.length > 0 && _react.createElement(
            ...
            _react.createElement(reactIntl.FormattedMessage, { id: notification.text })
          ),
...
var shake = _styledComponents.keyframes(['0%{transform:translateX(0);}25%{transform:translateX(10px);}75%{transform:translateX(-10px);}100%{transform:translateX(0);}']);
var FormWrapper = _styledComponents__default(FormWrapperUnstyled).withConfig({
